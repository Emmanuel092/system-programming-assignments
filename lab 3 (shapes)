    ...
    case WM_PAINT:
        {
			...
			// draw blue triangle
			HPEN htrianglepen;
			COLORREF qtriangleColour;
			qtriangleColour = RGB(0, 0, 225);
			htrianglepen = CreatePen(PS_SOLID, 3, qtriangleColour);
			hPenOld = (HPEN)SelectObject(hdc, htrianglepen);
			...
			// draw blue ellipse
			HPEN hellipsepen;
			COLORREF qellipseColour;
			qellipseColour = RGB(0, 0, 225);
			hellipsepen = CreatePen(PS_SOLID, 3, qellipseColour);
			hPenOld = (HPEN)SelectObject(hdc, hellipsepen);
			Arc(hdc, 500, 100, 800, 250, 0, 0, 0, 0);
			...
			// draw blue polygon
			HPEN hpolygonpen;
			COLORREF qpolygonColour;
			qpolygonColour = RGB(0, 0, 225);
			hpolygonpen = CreatePen(PS_SOLID, 3, qpolygonColour);
			hPenOld = (HPEN)SelectObject(hdc, hpolygonpen);

			MoveToEx(hdc, 900, 155, NULL);
			LineTo(hdc, 1100, 155);
			LineTo(hdc, 1100, 155);
			LineTo(hdc, 1165, 290);
			LineTo(hdc, 1165, 290);
